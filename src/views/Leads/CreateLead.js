        ...
        .then(response=>{
            console.log(response)
                this.setState({
                    ...
                    assignedTo:{label:response.data.data.data.assignedTo.fullName,value:response.data.data.data.assignedTo._id},
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <Row>
                                        ...
                                        <Col style={{marginTop:30}}>{(this.state.resultName.value == '618cd45e1d63033f109d5f6c') ? <><Input type='checkbox' name='checkbox' onChange={(e)=>this.checkboxChange(e)}/><Label htmlFor='checkbox'>Do you want to create new LeadLog?</Label></>: null}</Col>
                                    </Row>
                                </CardBody>
                            </Card> :null}
